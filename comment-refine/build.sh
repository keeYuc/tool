python -m grpc_tools.protoc -I ./protobuf -I ./protobuf/seo --python_out=./build --grpc_python_out=./build ./protobuf/seo/data.proto
python -m grpc_tools.protoc -I ./protobuf -I ./protobuf/seo  --python_out=./build --grpc_python_out=./build ./protobuf/seo/seo_service.proto
